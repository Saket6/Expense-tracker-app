...
function Navbar({isOpen}) {
    ...
    return (
        <>
         <div className="z-50 hidden md:block  min-h-screen left-slide  bg-opacity-95 transition-all duration-150   p-4 lg:p-0   bg-gray-800 lg:bg-transparent lg:h-100% md:h-auto  py-4 w-full col-span-2 ">
